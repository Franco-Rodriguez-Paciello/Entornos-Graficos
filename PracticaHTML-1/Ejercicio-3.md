...
-En el primer caso vemos un Enlace simple. Al hacer clic, lleva al usuario a la página de Google Argentina. El navegador navega en la misma pestaña/ventana.
-En el segundo se hace lo mismo que el anterior, pero se abre en una nueva pestaña o ventana.
...
-En el quinto vinculo te lleva a la seccion #arriba en caso de que exista alguna y muestra el texto Click aquí para volver arriba
...
-En el segundo caso la primera celda de la segunda fila se extiende a través de dos filas gracias al atributo rowspan="2". Contiene los atributos que eliminan el espacio entre las celdas y el espacio entre el contenido de la celda y sus bordes cellpadding="0" y cellspacing="0". 
...
-El primer caso ya tiene valores por defecto en los campos mientras que los otros dos no y abre una nueva pestaña al apretar el input que dispara un "submit".

-El segundo caso la clave es de tipo "text" y se visualizan los datos enviados por el metodo y abre una nueva pestaña al apretar el input que dispara un "submit".
...
- El primer código genera 2 radio buttons en los cuales solo se puede marcar una opción

- El segundo código  genera 2 radio buttons en los cuales se pueden seleccionar ambas opciones. Esto es debido a los valores del atributo name.
